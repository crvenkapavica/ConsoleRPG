...
CharDB::CharacterDataConstructor::CharacterDataConstructor() {
	...
	_data[ECharacterClass::FIRE_ELEMENTAL] = { ECharacterClass::FIRE_ELEMENTAL,		300.f,	0.f,		0.f,		0.f,		0.f,		0.03f,		140.f,		0.f,	0.08f,		200.f,		EDamageType::FIRE,			{0.f,	0.f,	0.f,	0.f,	0.f,	0.f},	{ESpellID::FIREBALL, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{},										{},						{}			};
			...
			// ENEMIES
	_data[ECharacterClass::E_GHOUL] = { ECharacterClass::E_GHOUL,					35.f,	20.f,		0.f,		25.f,		3.8f,		0.05f,		180.f,		10.f,	0.04f,		200.f,		EDamageType::PHYSICAL,		{0.f,	0.f,	0.f,	0.f,	0.f,	0.f},	{ESpellID::MELEE, 0},				{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::THORNS, 0},			{ESpellID::NONE, 0},			{},										{},						{1}			};
	_data[ECharacterClass::E_ARCHER] = { ECharacterClass::E_ARCHER,					500.f,	30.f,		0.f,		40.f,		5.2f,		0.07f,		190.f,		10.f,	0.04f,		210.f,		EDamageType::PHYSICAL,		{7.f,	7.f,	7.f,	7.f,	7.f,	0.f},	{ESpellID::RANGED, 0},				{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::THORNS, 0},			{ESpellID::NONE, 0},			{},										{},						{2}			};
	_data[ECharacterClass::E_MAGE] = { ECharacterClass::E_MAGE,						80.f,	50.f,		0.f,		55.f,		6.6f,		0.11f,		220.f,		10.f,	0.07f,		220.f,		EDamageType::PHYSICAL,		{10.f,	10.f,	10.f,	10.f,	10.f,	5.f},	{ESpellID::FIREBALL, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::THORNS, 0},			{ESpellID::NONE, 0},			{},										{},						{4}			};
}
