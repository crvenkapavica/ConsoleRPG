...
CharDB::CharacterDataConstructor::CharacterDataConstructor() {
	...
	_data[ECharacterClass::E_MAGE] = { ECharacterClass::E_MAGE,						26.f,	30.f,		10.f,		12.f,		6.6f,		0.11f,		220.f,		10.f,	0.07f,		220.f,		EDamageType::PHYSICAL,		{10.f,	10.f,	10.f,	10.f,	10.f,	5.f},	{ESpellID::FIREBALL, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{},										{},						{4}			};
	_data[ECharacterClass::E_WARLOCK] = { ECharacterClass::E_WARLOCK,				30.f,	50.f,		10.f,		20.f,		6.6f,		0.11f,		220.f,		10.f,	0.07f,		220.f,		EDamageType::PHYSICAL,		{10.f,	10.f,	10.f,	10.f,	10.f,	5.f},	{ESpellID::SUM_FIRE_IMP, 0},		{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{},										{},						{6}			};
	_data[ECharacterClass::E_SWORDSMAN] = { ECharacterClass::E_SWORDSMAN,			48.f,	0.f,		20.f,		45.f,		6.6f,		0.11f,		220.f,		10.f,	0.07f,		220.f,		EDamageType::PHYSICAL,		{10.f,	10.f,	10.f,	10.f,	10.f,	5.f},	{ESpellID::FIREBALL, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::THORNS, 0},			{ESpellID::NONE, 0},			{},										{},						{5}			};
	_data[ECharacterClass::E_FIRE_IMP] = { ECharacterClass::E_FIRE_IMP,				16.f,	40.f,		0.f,		4.f,		6.6f,		0.11f,		220.f,		10.f,	0.07f,		220.f,		EDamageType::PHYSICAL,		{10.f,	10.f,	10.f,	10.f,	10.f,	5.f},	{ESpellID::BURNING, 0},				{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{ESpellID::NONE, 0},			{},										{},						{3}			};
}
