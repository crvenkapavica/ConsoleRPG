...
//		               class			   health  essence    stamina       armor        AP       crit_chnc    crit_dmg		SP	  s_crit_chnc  s_crit_dmg	 a_r    f_r	     l_r    c_r     p_r		n_r			spell_1					s_2		s_3		s_4
		{ ECharacterClass::ENEMY_LVL1,		35.f,	20.f,		0.f,		25.f,		3.8f,		0.05f,		180.f,		10.f,	0.04f,		200.f,		{0.f,	0.f,	0.f,	0.f,	0.f,	0.f},	{ESpellID::THORNS, 0},	{},		{},		{} },
		{ ECharacterClass::ENEMY_LVL2,		50.f,	30.f,		0.f,		40.f,		5.2f,		0.07f,		190.f,		10.f,	0.04f,		210.f,		{7.f,	7.f,	7.f,	7.f,	7.f,	0.f},	{ESpellID::THORNS, 0},	{},		{},		{} },
		{ ECharacterClass::ENEMY_LVL3,		80.f,	50.f,		0.f,		55.f,		6.6f,		0.11f,		220.f,		10.f,	0.07f,		220.f,		{10.f,	10.f,	10.f,	10.f,	10.f,	5.f},	{ESpellID::THORNS, 0},	{},		{},		{} }
	};
