...
public:
    ...
    virtual void Apply(shared_ptr<Character> instigator, vector<shared_ptr<Character>>& targets) = 0;
...
protected:
    ...
    int AddRandomTargets(int r, vector<shared_ptr<Character>>& targets, const shared_ptr<Character>& character, const string& name);
...
public:
    ...
    virtual void Apply(shared_ptr<Character> instigator, vector<shared_ptr<Character>>& targets) override;
